...
%
%   FlowP=TriStream(tria,x,y,u,v,x0,y0) computes streamlines on the triangular mesh
%   specified by tria with nodal coordinates [x,y]. Streamlines are traced using the
...
%   PLOTTRISTREAM.
%
%   FlowP=TriStream(tria,x,y,u,v,x0,y0,verbose,maxits,Ltol,dLtol) allows enabling of a
%   progress report as TRISTREAM computes streamlines if verbose=1 (default verbose=0).
%
%
%   FlowP=TriStream(tria,x,y,u,v,x0,y0,verbose,maxits,Ltol,dLtol) allows additional control
...
%   distance (in barycentric coordinates) beyond an edge which is considered to
